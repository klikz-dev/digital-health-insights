  ...
  return (
    <Layout seo={HtmlParser(yoast_head)}>
      <AdvertiseHero
        ...
        description='Reach over 84,000 healthcare professionals working in large hospital
            systems, community & rural hospitals, integrated delivery networks,
            physician practices, clinics, long term care facilities and more.'
      />
